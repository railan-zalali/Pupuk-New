<x-app-layout>
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center">
                    ...
                    {{ __('Laporan Stok FIFO') }}
                </h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Lihat dan analisa data stok produk dengan metode FIFO (First In First Out)</p>
            </div>
            <x-report-export-buttons route="reports.fifo-stock" />
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Nilai Stok FIFO</h3>
                <p class="mt-2 text-md font-bold text-gray-900 dark:text-gray-100">Rp
                    {{ number_format($summary['total_fifo_value'], 0, ',', '.') }}</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="p-6">
                ...
                <form action="{{ route('reports.fifo-stock') }}" method="GET" class="flex items-center">
                    <div class="relative">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse($products as $product)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-xs text-gray-900 dark:text-gray-100">
                                        Rp {{ number_format($product->fifo_value, 0, ',', '.') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-xs text-gray-900 dark:text-gray-100">
