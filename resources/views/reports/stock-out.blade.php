        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center">
                    ...
                    {{ __('Laporan Stok Keluar') }}
                </h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Lihat dan analisa data stok keluar produk</p>
            </div>
            <x-report-export-buttons route="reports.stock-out" />
        </div>

        <!-- Filter Form -->
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <form action="{{ route('reports.stock-out') }}" method="GET" class="space-y-4">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                        Tidak ada data stok keluar untuk periode ini
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
