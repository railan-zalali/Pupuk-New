        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 animate-fade-in-up">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 ml-13">
                    Perbarui informasi data supplier
                </p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="name" name="name" type="text" class="pl-10 w-full" :value="old('name', $supplier->name)" required />
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="phone" name="phone" type="text" class="pl-10 w-full" :value="old('phone', $supplier->phone)" required />
                            </div>
                        </div>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div class="relative">
                                <textarea id="address" name="address" rows="3" class="input-field w-full pl-10 pt-2.5" required>{{ old('address', $supplier->address) }}</textarea>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div class="relative">
                                <textarea id="description" name="description" rows="3" class="input-field w-full pl-10 pt-2.5">{{ old('description', $supplier->description) }}</textarea>
                                <div class="absolute top-3 left-3 pointer-events-none">
