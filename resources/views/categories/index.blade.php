<x-app-layout>
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100">{{ __('Kategori') }}</h2>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                            ...
                                            Tidak ada kategori ditemukan</p>
                                                <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Tambahkan kategori baru untuk memulai
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
