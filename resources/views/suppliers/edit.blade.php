    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Edit informasi detail untuk supplier
                    </p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden border border-gray-200 dark:border-gray-700">
            <div class="px-4 py-5 sm:px-6 bg-gray-50 dark:bg-gray-800/80 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400">Edit detail informasi supplier</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="pl-10 mt-1 block w-full border-gray-300 dark:border-gray-600" :value="old('name', $supplier->name)" required placeholder="Masukkan nama supplier" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <x-text-input id="phone" name="phone" type="text" class="pl-10 mt-1 block w-full border-gray-300 dark:border-gray-600" :value="old('phone', $supplier->phone)" required placeholder="Masukkan nomor telepon" />
                                </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <textarea id="address" name="address" class="pl-10 mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-300" required placeholder="Masukkan alamat lengkap">{{ old('address', $supplier->address) }}</textarea>
                                </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <textarea id="description" name="description" class="pl-10 mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-300" placeholder="Masukkan deskripsi (opsional)">{{ old('description', $supplier->description) }}</textarea>
                                </div>
